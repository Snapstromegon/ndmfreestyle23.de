...
:::warningBox
Anmeldeschluss: {{ event.fristen.anmeldung | niceDate }}
:::
...
:::
:::iconBoxContent
SSVNümbrecht Turnen2010 e.V. unterstützt durch
den Einradverband Deutschland e.V. (EVD) und
den Bund Deutscher Radfahrer e.V. (BDR)
:::
::::
...
Die Kürmusik muss bis spätestens {{event.fristen.musikupload |niceDate}} im Anmeldetool hochgeladen werden. 
Es muss sich um mp3-Dateien mit mindestens 192 kBit/s handeln. 
Nach dem {{event.fristen.musikupload |niceDate}} sind Musikänderungen nicht mehr möglich.
...
Wenn ein To-Go-Becher mitgebracht oder vor Ort erworben wird, gewähren wir einen Nachlass von 0,50 € auf jedes Heißgetränk. Auf diese Weise leisten wir gemeinsam einen Beitrag zum Umweltschutz.

## Sanitätsdienst

Während der Wettkämpfe steht ein Sanitätsdienst zur Verfügung.
...
SSV Nümbrecht Einrad,
Peter Kaufmann

|         |                                                           |
| :------ | :-------------------------------------------------------- |
| Website | [ndmfreestyle23.de](https://ndmfreestyle23.de)            |
| Mail    | [info@ndmfreestyle23.de](mailto://info@ndmfreestyle23.de) |
